\section{Principal results and Proofs}
...
For convenience we write $u_{x_i} = u_i$ etc.
...
\noindent
2.3. \emph{Remark 1.} (This was pointed out to us by Spruck.)
...
\noindent
2.4. Theorem \ref{thm:2.1} extends to a class of nonlinear elliptic second order equations.
...
\noindent
2.5. We also obtain generalizations of Theorem \ref{thm:1} and \ref{thm:2}.
...
\vspace*{5pt}
\noindent
2.6. We also have the following extension of Theorem \ref{thm:3}.
...
\noindent
2.7. Here is another application of Theorem \ref{thm:2.1} with a novel conclusion.
...
\noindent
2.8. Theorem \ref{thm:1} yields a positive response to a question put us by C.~Holland.
